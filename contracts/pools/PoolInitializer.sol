 ...
 * @author d1ll0n
 * @dev Contract that acquires the initial balances for an nectar pool.
 *
 ...
 * When all the tokens needed are acquired, the nectar pool will be
 * initialized and this contract will receive the initial token supply (100).
 *
 * Once the contract receives the nectar pool tokens, users can claim their
