...
/* ========== External Interfaces ========== */
import "@nectar-fund/uniswap-v2-oracle/contracts/interfaces/IIndexedUniswapV2Oracle.sol";
import "@nectar-fund/proxies/contracts/interfaces/IDelegateCallProxyManager.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";

/* ========== External Libraries ========== */
import "@nectar-fund/uniswap-v2-oracle/contracts/lib/PriceLibrary.sol";
import "@nectar-fund/uniswap-v2-oracle/contracts/lib/FixedPoint.sol";
import "@nectar-fund/proxies/contracts/SaltyLib.sol";
...
/* ==========  Constants  ========== */
  ...
  // Identifier for the nectar pool implementation on the proxy manager.
...
/* ==========  Structs  ========== */
  ...
  /**
   * @dev Data structure with metadata about an nectar pool.
   *
...
/* ==========  Pool Deployment  ========== */
  ...
  /**
   * @dev Deploys an nectar pool and a pool initializer.
...
/* ==========  Pool Management  ========== */
  ...
  /**
   * @dev Sets the swap fee on an nectar pool.
   */
  ...
  /**
   * @dev Delegates a comp-like governance token from an nectar pool
